...
public class WalkingForward {
	...
	public static void animate(ArmorStand main, boolean shieldUp) {
		try {
			...
			leftFootPosition = PartPositioning.position(leftFoot, leftCalfPosition, leftCalf.getHeadPose(), new Vector(0,-0.585,-0.035), main.getLocation(), yaw);
			//Right
			...
			rightFootPosition = PartPositioning.position(rightFoot, rightCalfPosition, rightCalf.getHeadPose(), new Vector(0,-0.585,-0.035), main.getLocation(), yaw);
			//Right
