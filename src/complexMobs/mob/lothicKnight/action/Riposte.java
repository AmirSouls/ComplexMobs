...
public class Riposte extends Action {
	...
	protected void shield() {
		...
		AnimationState state = part.animationLargeFrame(0, 4, getTick(), 15, -115, 95, 15, -115, 95);
	...
	protected void rightHand() {
		...
		AnimationState state = part.animationLargeFrame(0, 4, getTick(), 90, -260, -260, 90, -260, -260);
		part.animationLargeFrame(20, 40, getTick(), -40, 0, 0, -40, 0, 0);
		part.animationLargeFrame(60, 65, getTick(), -10, -10, 60, -220, 0, 80);
		state = part.animationLargeFrame(85, 90, getTick(), -220, 0, 80, -90, -90, 180);
	...
	protected void sword() {
		...
		AnimationState state = part.animationLargeFrame(0, 4, getTick(), 40, 50, 0, 40, 50, 0);
		part.animationLargeFrame(20, 40, getTick(), 40, 50, 0, -40, -85, 0);
		part.animationLargeFrame(60, 65, getTick(), -40, -85, 0, -40, -95, 0);
		state = part.animationLargeFrame(85, 90, getTick(), -40, -95, 0, 0, 90, 0);
	...
	protected void leftThigh() {
		...
		AnimationState state = part.animationLargeFrame(0, 4, getTick(), -30, 10, 0, -30, 10, 0);
	}

	protected void leftCalf() {
		Part part = getMob().getParts().get("left_calf");
		
		AnimationState state = part.animationLargeFrame(0, 4, getTick(), 10, -10, -15, 10, -10, -15);
	}

	protected void leftFoot() {
		Part part = getMob().getParts().get("left_foot");
		
		AnimationState state = part.animationLargeFrame(0, 4, getTick(), 0, 10, 0, 0, 10, 0);
	}

	protected void rightThigh() {
		Part part = getMob().getParts().get("right_thigh");
		
		AnimationState state = part.animationLargeFrame(0, 4, getTick(), 0, 0, 10, 0, 0, 10);
	}
	...
	protected void rightFoot() {
		...
		AnimationState state = part.animationLargeFrame(0, 4, getTick(), 0, 70, 0, 0, 70, 0);
	}
}
